...
struct BoardView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .onReceive(viewModel.shouldPrompForPromotion, perform: {_ in
                self.isShowingPromotion = true
            })
            .confirmationDialog("Promover", isPresented: $isShowingPromotion) {
            ...
            .onChange(of: selectedPromotionType) {
                _, newPromotionType in
